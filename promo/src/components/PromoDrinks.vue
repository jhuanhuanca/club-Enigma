...
import { DRINK_CATALOG_TOTAL, FEATURED_DRINKS } from '../data'
...
<template>
  <section id="bebidas" class="promo-section" aria-label="carta de bebidas">
    <div class="promo-section__inner">
      ...
      <div class="promo-drinks-row">
        <article
          v-for="drink in FEATURED_DRINKS"
          :key="drink.id"
          class="promo-drink"
          :style="{ '--drink-accent': drink.accent }"
        >
          <div class="promo-drink__media">
            <img
              class="promo-drink__bg"
              :src="drink.image"
              :alt="drink.name"
              loading="lazy"
            />
            <div class="promo-drink__blur" />
            <div class="promo-drink__veil" />
            <img
              class="promo-drink__logo"
              :src="enigmaLogo"
              alt=""
              aria-hidden="true"
            />
          </div>
          <div class="promo-drink__body">
            <span class="promo-drink__tag">{{ drink.tag }}</span>
            <h3 class="promo-drink__name">{{ drink.name }}</h3>
            <p class="promo-drink__detail">{{ drink.detail }}</p>
          </div>
        </article>
        ...
        <aside class="promo-drinks-more">
          ...
          <a
            :href="waHref"
            class="promo-wa-btn promo-wa-btn--small"
            target="_blank"
          ...
          >
            ...
            Quiero ver la carta en el grupo
          </a>
        </aside>
      </div>
    </div>
